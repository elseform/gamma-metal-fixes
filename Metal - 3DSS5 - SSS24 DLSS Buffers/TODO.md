...
- [ ] <!-- task:trace-verify-magnifier-scene-final --> Post-fix GPU trace, EOTech EXPS3-2 + G33 magnifier combo (`e0t2_magd`) in line: the lens draw samples the 2560x1440 `scene_final` copy and its output contains the magnified EOTech dot.
